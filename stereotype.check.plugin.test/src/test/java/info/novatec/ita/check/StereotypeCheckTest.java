...
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleIsWithPackageNames;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleNoStereotype;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleWithInnerClassIs;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleWithPackageNamesIs;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleWithoutAnnotationIs;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleWithoutInterfaceIs;
import info.novatec.ita.check.testclasses.app1.main.bl.is.SampleWithoutPostfix;
import info.novatec.ita.check.testclasses.app1.main.bl.is.tf.BaseTf;
import info.novatec.ita.check.testclasses.app1.main.bl.is.tf.SampleApplicationScoped;
import info.novatec.ita.check.testclasses.app1.main.bl.is.tf.SampleTf;
import info.novatec.ita.check.testclasses.app1.main.bl.is.tf.SampleTfExtendsSampleNoTf;
import info.novatec.ita.check.testclasses.app1.main.bl.is.tf.SampleTfExtendsSampleTf;
import info.novatec.ita.check.testclasses.app1.main.bl.wrong.SampleWrongPackageIs;
import info.novatec.ita.check.testclasses.app1.main.data.dto.SampleDto;
import info.novatec.ita.check.testclasses.app1.main.data.dto.SampleDtoExtendsSampleDto;
import info.novatec.ita.check.testclasses.app1.main.data.dto.SampleDtoExtendsSampleNoDto;
import info.novatec.ita.check.testclasses.app1.main.data.dto.SampleNoBaseClassDto;
import info.novatec.ita.check.testclasses.app1.main.data.entity.AdditionalOperation;
import info.novatec.ita.check.testclasses.app1.main.data.entity.CustomerConcern;
import info.novatec.ita.check.testclasses.app1.main.data.entity.SampleEntity;
import info.novatec.ita.check.testclasses.app1.main.data.entity.SampleEntityWithoutBaseclass;
import info.novatec.ita.check.testclasses.app1.main.data.entity.common.BaseEntity;
import info.novatec.ita.check.testclasses.app1.main.init.SampleIf;
import info.novatec.ita.check.testclasses.app1.main.init.SampleNoStartupIf;
import info.novatec.ita.check.testclasses.app1.main.ul.App1TypedViewStereotype;
import info.novatec.ita.check.testclasses.app1.main.ul.wt.test.SampleApp1View;
import info.novatec.ita.check.testclasses.app1.main.ul.wt.test.SampleCoreView;
import info.novatec.ita.check.testclasses.app1.shared.bl.bs.SampleBs;
import info.novatec.ita.check.testclasses.app1.shared.bl.bs.SampleNoInterfaceBs;
...
import info.novatec.ita.check.testclasses.core.fwk.common.util.DateUtil;
import info.novatec.ita.check.testclasses.core.fwk.common.util.Util;
import info.novatec.ita.check.testclasses.core.fwk.main.ts.VersionTsBean;
...
public class StereotypeCheckTest extends AbstractStereotypeCheckTest {
	...
	public void testFailWithoutBaseclass() throws Exception {
		DefaultConfiguration main = createDefaultConfig();
		final String expected = 
				"Stereotype dto: does not extend info.novatec.ita.check.testclasses.core.fwk.api.data.dto.Pojo";
	...
	public void testWithoutAnnotation() throws Exception {
		DefaultConfiguration main = createDefaultConfig();
		final String expected = "Stereotype integrationservice: missing annotation info.novatec.ita.check.testclasses.core.fwk.common.bl.is.IntegrationServiceStereotype";
	...
	public void testWithoutInterface() throws Exception {
		DefaultConfiguration main = createDefaultConfig();
		final String expected = "Stereotype integrationservice: does not implement info.novatec.ita.check.testclasses.core.fwk.common.bl.is.IntegrationService";
	...
	public void testInterfaceNoInterface() throws Exception {
		DefaultConfiguration main = createDefaultConfig();
		final String expected = "Stereotype businessservice: does not extend info.novatec.ita.check.testclasses.core.fwk.api.bl.bs.BusinessService";
	...
	public void testThreePossibleBaseclasses() throws Exception {
		...
		String expectedFail = "Stereotype entity: does not extend info.novatec.ita.check.testclasses.app1.main.data.entity.CustomerConcern or info.novatec.ita.check.testclasses.app1.main.data.entity.common.BaseEntity or info.novatec.ita.check.testclasses.core.fwk.api.data.dto.Pojo";
	...
	public void testBaseClassIsNotStereotypeViaBaseClass() throws Exception {
		DefaultConfiguration main = createDefaultConfig();
		final String expected = "Stereotype dto: does not extend info.novatec.ita.check.testclasses.core.fwk.api.data.dto.Pojo";
