 ...
 * necessary for its stereotype. The IntegrationService is the second interface.
 * 
 * @author Volker Koch (NovaTec Consulting GmbH)
 *
 */
@IntegrationServiceStereotype
public class Sample2InterfacesIs implements Serializable, IntegrationService {
