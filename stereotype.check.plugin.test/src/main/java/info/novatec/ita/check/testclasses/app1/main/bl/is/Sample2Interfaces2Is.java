...
/**
 * This valid class implements more than one interfaces. One of them is
 * necessary for its stereotype. The IntegrationService is the first interface.
 * 
 * @author Volker Koch (NovaTec Consulting GmbH)
 *
 */
@IntegrationServiceStereotype
public class Sample2Interfaces2Is implements IntegrationService, Serializable {
